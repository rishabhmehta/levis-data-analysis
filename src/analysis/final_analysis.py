...
# Select relevant columns for the final structured output
final_output = data[['Region', 'Location', 'Theme', 'Sentiment', 'VoteChoice']]

# Save the final structured output to CSV
final_output.to_csv("structured_feedback_analysis.csv", index=False)

print("Analysis complete. Data saved to structured_feedback_analysis.csv")
